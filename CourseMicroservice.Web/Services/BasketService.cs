        ...
        ILogger<BasketService> logger)
    {
        ...
        public async Task<ServiceResult<BasketViewModel>> GetBasketsAsync()
        {
            ...
            var basketViewModel = new BasketViewModel(
                ...
                responseAsResult.Content.BasketItemList.Select(item => new BasketItemViewModel(
                    item.Id,
                    item.Name,
        ...
        public async Task<ServiceResult> ApplyDiscountAsync(string coupon)
        {
            ...
            var response = await basketRefitService.ApplyDiscountRateAsync(new ApplyDiscountRateRequest(coupon,
